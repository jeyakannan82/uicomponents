...
var CanvasJS = CanvasJSReact.CanvasJS;
 ...
 componentDidMount() {
 console.log('http://localhost:5000/aztecs/response?start_date=' + encodeURIComponent(this.props.startDate) +'&end_date=' + encodeURIComponent(this.props.endDate));
    const responseChart = fetch('http://localhost:5000/aztecs/response?start_date=' + encodeURIComponent(this.props.startDate) +'&end_date=' + encodeURIComponent(this.props.endDate))
