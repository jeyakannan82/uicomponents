...
var CanvasJS = CanvasJSReact.CanvasJS;
 ...
 class ReliabilityChart extends React.Component {
  ...
  componentDidMount() {
  console.log('http://localhost:5000/aztecs/reliability?start_date=' + encodeURIComponent(this.props.startDate) +'&end_date=' + encodeURIComponent(this.props.endDate));
    const responseChart = fetch('http://localhost:5000/aztecs/reliability?start_date=' + encodeURIComponent(this.props.startDate) +'&end_date=' + encodeURIComponent(this.props.endDate))
